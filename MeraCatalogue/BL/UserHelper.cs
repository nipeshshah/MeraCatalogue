...
namespace MeraCatalogue.BL
{
    ...
    {
        public string UpdateUserProfile(Models.GoogleUserProfile googleUserProfile)
        {
            ...
            string result = fw.db.ExecutScalarProcedureString("RegisterUser", new System.Data.SqlClient.SqlParameter[]
            {
                fw.db.SqlParameter("GoogleLoginId", System.Data.SqlDbType.NVarChar, 50, googleUserProfile.GoogleId),
